...
export const translations = {
  ...
  en: {
    ...
    chat: {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: 'Easiest way is a free intro call — tap “Book a free call” and pick a time, or email anantalegal9@gmail.com / call +9779806051559. We’ll listen first and tell you honestly whether you even need a lawyer yet.',
        },
      ],
    },
    ...
    hero: {
      badge: 'Licensed Advocate — Nepal Bar Council',
      l1: 'The',
      l2: "Entrepreneur's",
      l3: 'Lawyer',
      subPre: "Plain-English legal for founders who'd rather be shipping. Company setup, contracts, fundraising and IP — handled at ",
      subMark: 'startup speed',
      subPost: ', from Kathmandu to anywhere.',
      cta1: 'Book a free intro call',
      cta2: 'See what I handle',
      trust1: '200+ ventures advised',
      trust2: 'flat fees, no billable-hour games',
      trust3: 'replies within 24h',
      clauseTag: '§ 1.1 — THE FOUNDER CLAUSE',
      clausePre: 'The one who reads the ',
      clauseEdit: 'fine print',
      clauseIns: 'whole contract',
      clausePost: " so you don't have to.",
    },
    ...
    divider: {
      ...
      head: 'Everything a venture signs, files or fights over',
    },

    services: {
      label: '§ 01 / What I handle',
      head: 'Everything legal a venture needs',
      intro: 'Minus the jargon and the surprise invoices. Pick what you need today — or keep me on call for all of it.',
      ...
      items: [
        ...
        { title: 'Contracts, Redlined', desc: 'Founder agreements, NDAs, employment, SaaS and vendor deals. Drafted tight, negotiated tighter.' },
        { title: 'Fundraising & Investment', desc: 'Term sheets, SAFEs, share subscriptions, due diligence and FDI approvals — so the round actually closes.' },
        { title: 'Intellectual Property', desc: "Trademarks, copyright and the brand you're building. Own your name before someone else does." },
        { title: 'Compliance & Governance', desc: 'Annual filings, board resolutions, ROC and tax housekeeping. Stay clean, stay fundable.' },
        { title: 'Exits & Disputes', desc: 'Share transfers, acquisitions, and a steady hand when a deal — or a co-founder — goes sideways.' },
      ],
    },

    approach: {
      label: '§ 02 / Why founders stay',
      leadPre: 'Most lawyers bill you to ',
      leadEdit: 'think',
      leadIns: 'overthink',
      leadMid: ". I'd rather you ",
      leadMark: 'build',
      leadPost: '.',
      stats: [
        ...
        { n: '1', k: 'person who actually picks up the phone. Me.' },
      ],
    },
    ...
    stories: {
      ...
      head: 'Built with founders who ship',
      quotes: [
        { text: 'Registered my startup and closed my first cheque without a single all-nighter on paperwork. Worth every rupee.', name: 'Aastha K.', role: 'Founder, fintech' },
        { text: "Finally a lawyer who texts back and explains things like I'm a human, not a defendant.", name: 'Rishan T.', role: 'Co-founder, D2C brand' },
        { text: "The term sheet review caught two clauses that would've quietly cost me control of the company.", name: 'Bibek S.', role: 'CEO, SaaS startup' },
      ],
    },
    ...
    cta: {
      h1: "Let's make it",
      h2: 'legal.',
      p: 'Book a free intro call — and find out what your venture actually needs before you spend a single rupee on it.',
    ...
    footer: {
      ...
      brandB: 'Lawyer',
      tagline: 'Plain-English business & startup law for founders building in Nepal and beyond.',
      navigate: 'Navigate',
      getInTouch: 'Get in touch',
      address: 'Kathmandu, Nepal',
      hours: 'Mon–Fri · 10:00–18:00',
      copyright: '© 2026 The Entrepreneur\'s Lawyer. All rights reserved.',
    ...
    about: {
      label: '§ About',
      h1: 'Meet Sanskriti',
      sub: 'The advocate behind the practice — building a new kind of legal experience for founders in Nepal.',
      badgeName: 'Sanskriti',
      badgeTitle: 'Licensed Advocate · Nepal Bar Council',
      bioHead: 'A lawyer who speaks founder, not legalese.',
      bio: [
        'Sanskriti is a licensed advocate enrolled with the Nepal Bar Council, specializing in startup and business law. She founded Ananta Legal with a single mission: make legal accessible, affordable, and actually useful for entrepreneurs.',
        "After seeing too many founders lose equity, miss deadlines, and sign contracts they didn't understand, she built a practice that works the way startups do — fast, transparent, and without the billable-hour games.",
        'With 200+ ventures advised, from solo bootstrappers to VC-backed teams, Sanskriti handles everything from company incorporation and investor term sheets to IP protection and regulatory compliance. She\'s the one person who actually picks up the phone.',
        "When she's not drafting contracts, you'll find her mentoring at startup weekends, nerding out over cap table structures, or explaining FDI rules in plain English over coffee.",
      ],
      credentials: [
      ...
      valuesLabel: '§ Values',
      valuesHead: 'What I believe in',
      values: [
        { title: 'Plain English, always', desc: "If you can't understand your own contract, it's not protecting you. Every document I deliver is written for humans." },
        { title: 'Flat fees, no games', desc: "You'll know exactly what you're paying before I start. No surprises, no billable-hour anxiety." },
        { title: 'Startup speed', desc: 'Your fundraise can\'t wait 3 weeks for a contract review. I work on founder timelines, not legacy law firm schedules.' },
      ],
      labels: { intro: 'About', bio: 'Sanskriti', values: 'Values' },
    },

    practiceAreas: {
      label: '§ Practice Areas',
      h1: 'Everything legal a venture needs',
      sub: 'Minus the jargon and the surprise invoices. Pick what you need today — or keep me on call for all of it.',
      learnMore: 'Learn more',
      labels: { intro: 'Practice Areas', grid: 'All services' },
      items: [
        { title: 'Company Formation', desc: 'Private limited registration, OCR, PAN & VAT, and the founder paperwork — incorporated in days, not weeks.', features: ['Private Limited Registration', 'OCR & PAN Setup', 'Founder Agreements', 'Partnership Deeds'] },
        { title: 'Contracts, Redlined', desc: 'Founder agreements, NDAs, employment, SaaS and vendor deals. Drafted tight, negotiated tighter.', features: ['NDA & Confidentiality', 'SaaS Agreements', 'Employment Contracts', 'Vendor & Service Deals'] },
        { title: 'Fundraising & Investment', desc: 'Term sheets, SAFEs, share subscriptions, due diligence and FDI approvals — so the round actually closes.', features: ['Term Sheet Review', 'SAFE Notes', 'FDI Approvals', 'Due Diligence Support'] },
        { title: 'Intellectual Property', desc: "Trademarks, copyright and the brand you're building. Own your name before someone else does.", features: ['Trademark Registration', 'Copyright Filing', 'Brand Protection', 'IP Strategy'] },
        { title: 'Compliance & Governance', desc: 'Annual filings, board resolutions, ROC and tax housekeeping. Stay clean, stay fundable.', features: ['Annual Filings', 'Board Resolutions', 'ROC Compliance', 'Tax Housekeeping'] },
        { title: 'Exits & Disputes', desc: 'Share transfers, acquisitions, and a steady hand when a deal — or a co-founder — goes sideways.', features: ['Share Transfers', 'Acquisition Structuring', 'Dispute Resolution', 'Co-founder Exits'] },
      ],
    },
      ...
      details: {
        'company-formation': {
          ...
          sections: [
            ...
            { heading: 'How I work differently', text: "Most lawyers treat incorporation like a form-filling exercise. I treat it like the foundation of your company — because it is. I'll help you choose the right structure, split equity fairly, and set up governance that scales. Everything is done remotely where possible, with plain-English explanations at every step." },
          ],
    ...
    contact: {
      ...
      sub: 'No billable-hour surprises. Drop me a message to book a free intro call or get a flat-fee quote.',
      ...
      officeName: 'Ananta Legal Chamber',
      officeAddr: 'Putalisadak, Kathmandu, Nepal',
      ...
      fMessage: "Briefly describe what you're building",
      fMessagePh: 'Tell me a bit about your venture and what you need legal help with...',
      submit: 'Submit Request',
      successTitle: 'Success!',
      successBody: 'Your request has been sent. Sanskriti will get back to you within 24 hours.',
    ...
    origin: {
      ...
      sub: 'The story of building a law firm built for builders.',
      journeyHead: 'The Journey',
      journey: [
        { year: '2023 — The Seed', h: 'The Legacy Problem', p: "While practicing at traditional corporate law firms in Kathmandu, Sanskriti noticed a pattern: early-stage founders were either priced out of high-quality legal help or received documents filled with archaic jargon that didn't fit how technology startups operate." },
        { year: '2024 — The Experiment', h: 'Flat-Fee Consulting', p: "Sanskriti started helping founders on the side with clear, flat-quoted prices. No billing by the minute, no surprise invoices. The response was immediate — founders didn't just want legal advice; they wanted a partner who worked at their speed." },
        { year: '2026 — Today', h: 'Ananta Legal', p: 'Ananta Legal was officially established in Kathmandu as a dedicated firm for tech startups, businesses, and cross-border ventures. Today, we advise over 200 ventures across fintech, SaaS, and D2C.' },
      ],
      ...
      why: [
        ...
        { emoji: '🤝', h: 'Plain English partnerships', p: 'We believe contracts are collaborative business tools, not hostile academic papers. We draft clean, clear documents both sides can easily read.' },
      ],
  ...
  ne: {
    ...
    chat: {
      ...
      faqs: [
        ...
        },
        {
          ...
          a: 'सजिलो तरिका नि:शुल्क परिचय कल हो — “नि:शुल्क कल बुक गर्नुहोस्” थिच्नुहोस्, वा anantalegal9@gmail.com / +9779806051559। हामी पहिले सुन्छौं र इमानदारीपूर्वक भन्छौं।',
        },
      ],
    },
    ...
    hero: {
      ...
      l2: 'भरपर्दो',
      l3: 'वकिल',
      subPre: 'काम गर्न रुचाउने संस्थापकहरूका लागि सरल भाषामा कानुनी सेवा। कम्पनी दर्ता, करार, लगानी जुटाउने र बौद्धिक सम्पत्ति — सबै ',
      subMark: 'स्टार्टअप गतिमा',
      subPost: ', काठमाडौँबाट जहाँसुकै।',
      cta1: 'नि:शुल्क परिचय कल बुक गर्नुहोस्',
      cta2: 'मैले के गर्छु हेर्नुहोस्',
      trust1: '२००+ उद्यमलाई सल्लाह',
      trust2: 'एकमुष्ट शुल्क, घण्टा गन्ने झमेला छैन',
      trust3: '२४ घण्टाभित्र जवाफ',
      clauseTag: '§ १.१ — संस्थापक धारा',
      clausePre: 'जसले ',
      clauseEdit: 'साना अक्षर',
      clauseIns: 'पूरै करार',
      clausePost: ' पढिदिन्छ, ताकि तपाईंलाई पढ्नु नपरोस्।',
    },
    ...
    services: {
      label: '§ ०१ / म के सम्हाल्छु',
      head: 'उद्यमलाई चाहिने सबै कानुनी सेवा',
      intro: 'जटिल शब्दजाल र अनपेक्षित बिल बिना। आज जे चाहिन्छ छान्नुहोस् — वा सबैका लागि मलाई साथमा राख्नुहोस्।',
      learnMore: 'थप जान्नुहोस्',
      items: [
        { title: 'कम्पनी दर्ता', desc: 'प्राइभेट लिमिटेड, OCR दर्ता, PAN र VAT, र संस्थापक कागजात — हप्तौं होइन, केही दिनमै दर्ता।' },
        { title: 'करार, रेडलाइन सहित', desc: 'संस्थापक करार, NDA, रोजगारी, SaaS र विक्रेता सम्झौता। बलियो मस्यौदा, अझ बलियो वार्ता।' },
        { title: 'लगानी जुटाउने', desc: 'टर्म सिट, SAFE, सेयर सब्स्क्रिप्सन, ड्यु डिलिजेन्स र वैदेशिक लगानी स्वीकृति — ताकि राउन्ड साँच्चै बन्द होस्।' },
        { title: 'बौद्धिक सम्पत्ति', desc: 'ट्रेडमार्क, प्रतिलिपि अधिकार र तपाईंले बनाउँदै गरेको ब्रान्ड। अरूले लिनुअघि आफ्नो नाम आफ्नै बनाउनुहोस्।' },
        { title: 'अनुपालन र सुशासन', desc: 'वार्षिक विवरण, सञ्चालक निर्णय, ROC र कर व्यवस्थापन। सफा रहनुहोस्, लगानीयोग्य रहनुहोस्।' },
        { title: 'निकास र विवाद', desc: 'सेयर हस्तान्तरण, अधिग्रहण, र सम्झौता — वा सह-संस्थापक — बिग्रिँदा स्थिर हात।' },
      ],
    },

    approach: {
      label: '§ ०२ / संस्थापकहरू किन रहन्छन्',
      leadPre: 'धेरै वकिलले तपाईंलाई ',
      leadEdit: 'सोच्न',
      leadIns: 'अति सोच्न',
      leadMid: ' बिल गर्छन्। म चाहन्छु तपाईं ',
      leadMark: 'बनाउनुहोस्',
      leadPost: '।',
      stats: [
    ...
    footer: {
      brandA: 'उद्यमीहरूको',
      brandB: 'वकिल',
      tagline: 'नेपाल र बाहिर उद्यम बनाउने संस्थापकहरूका लागि सरल भाषामा व्यवसाय र स्टार्टअप कानुन।',
      navigate: 'नेभिगेट',
    ...
    about: {
      label: '§ हाम्रोबारे',
      h1: 'संस्कृतिलाई चिन्नुहोस्',
      sub: 'अभ्यासपछाडिको अधिवक्ता — नेपालका संस्थापकहरूका लागि नयाँ खालको कानुनी अनुभव निर्माण गर्दै।',
      badgeName: 'संस्कृति',
      badgeTitle: 'इजाजतप्राप्त अधिवक्ता · नेपाल बार काउन्सिल',
      bioHead: 'कानुनी जटिलता होइन, संस्थापकको भाषा बोल्ने वकिल।',
      bio: [
        'संस्कृति नेपाल बार काउन्सिलमा दर्ता भएकी इजाजतप्राप्त अधिवक्ता हुन्, जो स्टार्टअप र व्यवसाय कानुनमा विशेषज्ञ छिन्। उनले एउटै लक्ष्यका साथ Ananta Legal स्थापना गरिन्: कानुनलाई उद्यमीहरूका लागि सुलभ, किफायती र साँच्चै उपयोगी बनाउने।',
        'धेरै संस्थापकहरूले इक्विटी गुमाएको, म्याद नाघेको र नबुझेका करारमा हस्ताक्षर गरेको देखेपछि, उनले स्टार्टअपजसरी नै काम गर्ने अभ्यास बनाइन् — छिटो, पारदर्शी, र घण्टा गन्ने झमेला बिना।',
        '२००+ उद्यमलाई सल्लाह दिएकी, एकल बुटस्ट्र्यापरदेखि भीसी-समर्थित टोलीसम्म, संस्कृतिले कम्पनी दर्तादेखि लगानीकर्ताको टर्म सिट, बौद्धिक सम्पत्ति सुरक्षा र नियामक अनुपालनसम्म सबै सम्हाल्छिन्। उनी फोन साँच्चै उठाउने एक्लो व्यक्ति हुन्।',
        'करार मस्यौदा नगर्दा उनलाई स्टार्टअप वीकेन्डमा मेन्टरिङ गर्दै, क्याप टेबल संरचनामा रमाउँदै, वा कफीसँगै सरल भाषामा वैदेशिक लगानी नियम बुझाउँदै भेट्न सकिन्छ।',
      ],
      credentials: [
      ...
      valuesHead: 'म केमा विश्वास गर्छु',
      values: [
        { title: 'सधैँ सरल भाषा', desc: 'आफ्नै करार बुझ्न सक्नुहुन्न भने त्यसले तपाईंलाई जोगाउँदैन। म दिने हरेक कागजात मान्छेका लागि लेखिएको हुन्छ।' },
        { title: 'एकमुष्ट शुल्क, झमेला छैन', desc: 'म सुरु गर्नुअघि नै कति तिर्नुहुन्छ ठ्याक्कै थाहा हुन्छ। कुनै आश्चर्य छैन, घण्टा गन्ने तनाव छैन।' },
        { title: 'स्टार्टअप गति', desc: 'तपाईंको लगानी जुटाउने काम करार समीक्षाका लागि ३ हप्ता पर्खन सक्दैन। म पुरानो ल फर्मको होइन, संस्थापकको समयतालिकामा काम गर्छु।' },
      ],
      labels: { intro: 'हाम्रोबारे', bio: 'संस्कृति', values: 'मूल्यमान्यता' },
    },

    practiceAreas: {
      label: '§ सेवा क्षेत्रहरू',
      h1: 'उद्यमलाई चाहिने सबै कानुनी सेवा',
      sub: 'जटिल शब्दजाल र अनपेक्षित बिल बिना। आज जे चाहिन्छ छान्नुहोस् — वा सबैका लागि मलाई साथमा राख्नुहोस्।',
      learnMore: 'थप जान्नुहोस्',
    ...
    contact: {
      ...
      sub: 'घण्टा गन्ने कुनै आश्चर्य छैन। नि:शुल्क परिचय कल बुक गर्न वा एकमुष्ट मूल्य लिन सन्देश पठाउनुहोस्।',
      ...
      officeName: 'Ananta Legal Chamber',
      officeAddr: 'पुतलीसडक, काठमाडौँ, नेपाल',
      ...
      successTitle: 'सफल!',
      successBody: 'तपाईंको अनुरोध पठाइयो। संस्कृतिले २४ घण्टाभित्र जवाफ दिनुहुनेछ।',
